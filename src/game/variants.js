const PRESETS = [
  {
    ...
    config: {
      ...
      randomJokerRankCount: 1,
      randomJokerSuit: false,
      randomJokerSuitCount: 1,
...
export function normalizeConfig(input = {}) {
  ...
  return {
    ...
    randomJokerRankCount: clamp(
      Number(input.randomJokerRankCount || DEFAULT_CONFIG.randomJokerRankCount),
      1,
      RANK_OPTIONS.length,
    ),
    randomJokerSuit: Boolean(input.randomJokerSuit),
    randomJokerSuitCount: clamp(
      Number(input.randomJokerSuitCount || DEFAULT_CONFIG.randomJokerSuitCount),
      1,
      SUIT_OPTIONS.length,
    ),
    sideShowEnabled: true,
